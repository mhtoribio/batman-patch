...
{
	batadv_v_elp_throughput_override_init(hard_iface);
...
/**
 * batadv_v_hardif_free() - free the algorithm specific fields in the
 *  hard-interface object
 * @hard_iface: the hard-interface to free
 */
void batadv_v_hardif_free(struct batadv_hard_iface *hard_iface)
{
	batadv_v_elp_throughput_override_free(hard_iface);
}
