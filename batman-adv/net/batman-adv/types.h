...
/**
 * struct batadv_neigh_throughput_override - per-neighbor throughput override
 */
struct batadv_neigh_throughput_override {
...
/**
 * struct batadv_neigh_throughput_override_table - per-neighbor throughput override table
 */
struct batadv_neigh_throughput_override_table {
	spinlock_t lock;
...
struct batadv_hard_iface {
	...
	/**
	 * @tp_override: list of throughput overrides for single hop neighbors
	 */
	struct batadv_neigh_throughput_override_table tp_override;
